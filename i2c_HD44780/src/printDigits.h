...
void great_19() { write_dat(LCD_PROBELPOZYTYV); write_dat(LCD_PROBELPOZYTYV); }
void great_degres() { write_dat(0x4f); write_dat(LCD_PROBELPOZYTYV); }
// ******************************************** //
...
void simvol_2(int pos) {
   if (lcd_l == 1) {
	...
	if (wide_simvol == '1') {
		...
		write_CMD(LCD_SETSTROKA3 + pos); write_dat(LCD_CGRAM5); great_19();
...
void simvol_3(int pos) {
   if (lcd_l == 1) {
	...
	if (wide_simvol == '1') {
		...
		write_CMD(LCD_SETSTROKA1 + pos); great_1();
		write_CMD(LCD_SETSTROKA2 + pos); great_15();
		write_CMD(LCD_SETSTROKA3 + pos); great_19(); write_dat(LCD_CGRAM4);
		write_CMD(LCD_SETSTROKA4 + pos); great_2();
	}
   }
}
...
void simvol_C(int pos) {
   if (lcd_l == 1) {
		// символ на две строки
	if (wide_simvol == '1') {
		write_CMD(LCD_SETSTROKA1 + pos); great_degres(); great_0();
		write_CMD(LCD_SETSTROKA2 + pos); great_19(); great_16();
	} else if (wide_simvol == '2') {
		write_CMD(LCD_SETSTROKA3 + pos); great_degres(); great_0();
		write_CMD(LCD_SETSTROKA4 + pos); great_19(); great_16();
	} else if ((wide_simvol == '3') || (wide_simvol == '4')) { // символ на четыре строки
		write_CMD(LCD_SETSTROKA1 + pos); great_degres(); great_1();
		write_CMD(LCD_SETSTROKA2 + pos); great_19(); great_12();
		write_CMD(LCD_SETSTROKA3 + pos); great_19(); great_12();
		write_CMD(LCD_SETSTROKA4 + pos); great_19(); great_2();
	}
   }
}
// ******************************************** //
